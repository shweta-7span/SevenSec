...
//        long totalAppUsageTime = lastAppUsageTime + appUsageTotalTime;
    ...
    public void getTotalAppUsageTimeForDate(String device_id, String app_package, AppUsageFromFireStore appUsageFromFirestore) {
        ...
        if (currentUser != null) {
            firebaseFirestore.collection(DB_COLLECTION_USERS).document(currentUser.getUid()).addSnapshotListener(new EventListener<DocumentSnapshot>() {
                @Override
                public void onEvent(@Nullable DocumentSnapshot document, @Nullable FirebaseFirestoreException error) {
                    ...
                    if(error!=null){
                        Dlog.e("getTotalAppUsageTimeForDate onFailure: " + error.getMessage());
                    }
                }
            });
        }
